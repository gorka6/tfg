...
<body>
  ...
  <div class="section">
    ...
    <p><strong>{{ translate_key('create.subrace', $translations) }}:</strong>
      ...
      @else
      {{ translate_key('subraces.no_subrace', $translations, 'Sin subraza') }}
      @endif
    </p>
    ...
    <p><strong>{{ translate_key('create.align', $translations, 'Alineamiento') }}:</strong>
  ...
  <div class="section">
    <h3>{{ translate_key('create.languages', $translations, 'Idiomas') }}</h3>
    <ul class="listado">
