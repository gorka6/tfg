export default {
  ...
  home: {
    ...
    body_1: "Welcome to Hero Forge, a place where creating your Dungeons & Dragons character is as thrilling as embarking on your first adventure. Here you can shape a hero from scratch, combining imagination with tools designed for players who love immersing themselves in fantasy.",
    subtitle_2: "RACE AND SUBRACE",
    body_2: "Choose the race and subrace to define your origins and the legacy that runs through your blood. Each lineage brings its own style, unique traits, and narrative possibilities, allowing you to design a hero that fits you.",
    subtitle_3: "CLASSES AND ABILITIES",
    body_3: "Select your class and customize skills, traits, and special features to match your character vision. Whether you want to unleash arcane power, wield an enchanted sword, or support your party with divine might.",
    subtitle_4: "ROLL ATTRIBUTE DICE",
    body_4: "Feel the excitement of rolling dice to generate all stats directly on the page. Just as thrilling as watching real dice tumble on a tavern table. You’ll create heroes with legendary strengths… or memorable flaws.",
    subtitle_5: "DOWNLOAD YOUR CHARACTER SHEET AS PDF",
    body_5: "Once your sheet is complete and ready to face the world, you can download it as a clean, organized PDF. Print it for your next session or share it with your group.",
    subtitle_6: "PERFORM CHECK ROLLS",
